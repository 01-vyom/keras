...
def MobileNetV2(input_shape=None,
  ...
  Args:
    ...
    alpha: Controls the width of the network. This is known as the width
      multiplier in the MobileNetV2 paper, but the name is kept for consistency
    ...
    pooling: Pooling mode for feature extraction when `include_top` is `False`.
      ...
      - `max` means that global max pooling will
          be applied.
    classes: Number of classes to classify images into, only to be specified if
